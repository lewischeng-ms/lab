...
namespace Microsoft.AspNet.OData.Formatters
{
    public class ODataJsonConverter : JsonConverter
    {
        ...
        public ODataJsonConverter(Uri serviceRoot, IEdmModel model)
        {
        ...
        private string GenerateIdLinkString(object value)
        {
            ...
            var keyName = entitySet.EntityType().Key().Single().Name;
            var keyProperty = GetPublicProperty(valueType, keyName);
